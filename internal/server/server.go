...
func (s *Server) setupRoutes() {
	...
	updateStockUC := sakeUsecase.NewUpdateStockUsecase(sakeRepo, sakeQuery, s3Client)
	deleteStockUC := sakeUsecase.NewDeleteStockUsecase(sakeRepo, sakeQuery, s3Client)
